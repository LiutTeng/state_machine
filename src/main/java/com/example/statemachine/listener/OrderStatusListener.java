...
//            System.out.println(String.format(FORMAT, OrderEvent.READY_SEND.getEventCode(), ord.getOid(), ord.getStatus()));
//        });
//        return true;
//    }
//
...
//            System.out.println(String.format(FORMAT, OrderEvent.CONFIRM_ACC.getEventCode(), ord.getOid(), ord.getStatus()));
//        });
//        return true;
//    }
//
...
//            System.out.println(String.format(FORMAT, OrderEvent.REFUND_SUC.getEventCode(), ord.getOid(), ord.getStatus()));
//        });
//        return true;
//    }
}
